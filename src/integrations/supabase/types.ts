    ...
    Tables: {
      ...
      fechamentos: {
        Row: {
          ...
          total_entradas_dinheiro: number | null
          total_geral_entradas: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "fechamentos_caixa_id_fkey"
            columns: ["caixa_id"]
            isOneToOne: false
      ...
      movimentacoes: {
        ...
        Relationships: [
          {
            foreignKeyName: "movimentacoes_caixa_id_fkey"
            columns: ["caixa_id"]
            isOneToOne: false
            referencedRelation: "caixas"
            referencedColumns: ["id"]
